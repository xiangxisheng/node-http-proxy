...
const proxy_port = process.argv[4] ? parseInt(process.argv[4], 10) : 80;
const proxy_host = process.argv[5] ? process.argv[5] : '10.86.2.72';
config.sys.http.proxy_pass = 'http://' + proxy_host + ':' + proxy_port;//反向代理后端WEB
